...
class _TranslationsChangeLanguagePageZhHans implements TranslationsChangeLanguagePageEn {
	...
	// Translations
	@override late final _TranslationsChangeLanguagePageTitleZhHans title = _TranslationsChangeLanguagePageTitleZhHans._(_root);
...
class _TranslationsChangeLanguagePageTitleZhHans implements TranslationsChangeLanguagePageTitleEn {
...
extension on TranslationsZhHans {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'ChangeLanguagePage.title.title': return '语言';
