...
class _TranslationsAccountPageDiaLogZhHans implements TranslationsAccountPageDiaLogEn {
	...
	@override String get google_text => '是否要解除当前账户与Google账户的连接？';
	@override String get apple_text => '是否要解除当前账户与Apple账户的连接？';
}
...
extension on TranslationsZhHans {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'accountPage.diaLog.google_text': return '是否要解除当前账户与Google账户的连接？';
			case 'accountPage.diaLog.apple_text': return '是否要解除当前账户与Apple账户的连接？';
