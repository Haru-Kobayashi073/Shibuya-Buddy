...
class TranslationsZhHans implements Translations {
	...
	@override late final _TranslationsChangeLanguageZhHans ChangeLanguage = _TranslationsChangeLanguageZhHans._(_root);
...
// Path: ChangeLanguage
class _TranslationsChangeLanguageZhHans implements TranslationsChangeLanguageEn {
	_TranslationsChangeLanguageZhHans._(this._root);

	final TranslationsZhHans _root; // ignore: unused_field

	// Translations
	@override late final _TranslationsChangeLanguageItemsZhHans items = _TranslationsChangeLanguageItemsZhHans._(_root);
}
...
class _TranslationsChangeLanguageItemsZhHans implements TranslationsChangeLanguageItemsEn {
	_TranslationsChangeLanguageItemsZhHans._(this._root);
...
extension on TranslationsZhHans {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'ChangeLanguage.items.japanese': return '日本人';
			case 'ChangeLanguage.items.english': return '英语';
			case 'ChangeLanguage.items.chinese_simplified': return '中文（简体）';
			case 'ChangeLanguage.items.chinese_traditional': return '中文（繁体）';
