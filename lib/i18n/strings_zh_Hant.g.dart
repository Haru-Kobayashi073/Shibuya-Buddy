...
class TranslationsZhHant implements Translations {
	...
	@override late final _TranslationsChangeLanguageZhHant ChangeLanguage = _TranslationsChangeLanguageZhHant._(_root);
...
// Path: ChangeLanguage
class _TranslationsChangeLanguageZhHant implements TranslationsChangeLanguageEn {
	_TranslationsChangeLanguageZhHant._(this._root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override late final _TranslationsChangeLanguageItemsZhHant items = _TranslationsChangeLanguageItemsZhHant._(_root);
}
...
class _TranslationsChangeLanguageItemsZhHant implements TranslationsChangeLanguageItemsEn {
	_TranslationsChangeLanguageItemsZhHant._(this._root);
...
extension on TranslationsZhHant {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'ChangeLanguage.items.japanese': return '日语';
			case 'ChangeLanguage.items.english': return '英语';
			case 'ChangeLanguage.items.chinese_simplified': return '中文(简体字)';
			case 'ChangeLanguage.items.chinese_traditional': return '中文(繁体字)';
			case 'ChangeLanguage.items.language': return '语言';
