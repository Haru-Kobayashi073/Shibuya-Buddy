...
class _TranslationsAccountPageDiaLogZhHant implements TranslationsAccountPageDiaLogEn {
	...
	@override String get google_text => '是否要解除目前帳戶與Google帳戶的連結？';
	@override String get apple_text => '是否要解除目前帳戶與Apple帳戶的連結？';
}
...
extension on TranslationsZhHant {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'accountPage.diaLog.google_text': return '是否要解除目前帳戶與Google帳戶的連結？';
			case 'accountPage.diaLog.apple_text': return '是否要解除目前帳戶與Apple帳戶的連結？';
