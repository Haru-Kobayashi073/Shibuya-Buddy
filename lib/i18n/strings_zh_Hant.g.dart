...
class TranslationsZhHant implements Translations {
  ...
  @override
  late final _TranslationsChangeLanguageZhHant ChangeLanguage =
      _TranslationsChangeLanguageZhHant._(_root);
  @override
...
// Path: ChangeLanguage
class _TranslationsChangeLanguageZhHant
    implements TranslationsChangeLanguageEn {
  ...
  // Translations
  @override
  late final _TranslationsChangeLanguageItemsZhHant items =
      _TranslationsChangeLanguageItemsZhHant._(_root);
}
...
class _TranslationsChangeLanguageItemsZhHant
    implements TranslationsChangeLanguageItemsEn {
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'NavigationBar.items.myPage':
        return '我的頁面';
      case 'ChangeLanguage.items.japanese':
        return '日语';
      case 'ChangeLanguage.items.english':
        return '英语';
      case 'ChangeLanguage.items.chinese_simplified':
        return '中文(简体字)';
      case 'ChangeLanguage.items.chinese_traditional':
        return '中文(繁体字)';
      case 'ChangeLanguage.items.language':
        return '语言';
      case 'locales.en':
        return '英語';
      case 'locales.ja':
