...
class _TranslationsChangeLanguagePageZhHant implements TranslationsChangeLanguagePageEn {
	...
	// Translations
	@override late final _TranslationsChangeLanguagePageTitleZhHant title = _TranslationsChangeLanguagePageTitleZhHant._(_root);
...
class _TranslationsChangeLanguagePageTitleZhHant implements TranslationsChangeLanguagePageTitleEn {
	_TranslationsChangeLanguagePageTitleZhHant._(this._root);
...
extension on TranslationsZhHant {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'ChangeLanguagePage.title.title': return '語言';
