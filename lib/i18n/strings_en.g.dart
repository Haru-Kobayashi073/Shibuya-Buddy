...
class TranslationsAccountPageDiaLogEn {
	...
	String get google_text => 'Do you want to unlink the current account from your Google account?';
	String get apple_text => 'Do you want to unlink the current account from your Apple account?';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'accountPage.diaLog.google_text': return 'Do you want to unlink the current account from your Google account?';
			case 'accountPage.diaLog.apple_text': return 'Do you want to unlink the current account from your Apple account?';
