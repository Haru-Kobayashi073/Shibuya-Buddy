...
class TranslationsChangeLanguagePageEn {
	...
	// Translations
	late final TranslationsChangeLanguagePageTitleEn title = TranslationsChangeLanguagePageTitleEn._(_root);
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'ChangeLanguagePage.title.title': return 'Language';
