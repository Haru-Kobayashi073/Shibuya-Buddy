...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsChangeLanguageEn ChangeLanguage =
      TranslationsChangeLanguageEn._(_root);
...
class TranslationsChangeLanguageEn {
  ...
  // Translations
  late final TranslationsChangeLanguageItemsEn items =
      TranslationsChangeLanguageItemsEn._(_root);
}
