...
class TranslationsAuthenticationSignUpPageEn {
  ...
  // Translations
  late final TranslationsAuthenticationSignUpPageTitleEn title =
      TranslationsAuthenticationSignUpPageTitleEn._(_root);
  ...
  late final TranslationsAuthenticationSignUpPageButtonEn button =
      TranslationsAuthenticationSignUpPageButtonEn._(_root);
}
...
class TranslationsCreatePlanPageSnackBarErrorEn {
  ...
  String get invalidDateRange =>
      'The start date must be set before the end date.';
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'createPlanPage.snackBar.error.invalidDateRange':
        return 'The start date must be set before the end date.';
