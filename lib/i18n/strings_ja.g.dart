...
class _TranslationsAccountPageSnackBarJa implements TranslationsAccountPageSnackBarEn {
	...
	@override String get accountLinked => 'このアカウントはすでに連携済みです。';
...
class _TranslationsAccountPageDiaLogJa implements TranslationsAccountPageDiaLogEn {
	...
	@override String get google_text => '現在のアカウントとGoogleアカウントの連携を解除しますか？';
	@override String get apple_text => '現在のアカウントとAppleアカウントの連携を解除しますか？';
}
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'accountPage.snackBar.loggedOut': return 'ログアウトしました。';
			...
			case 'accountPage.snackBar.accountLinked': return 'このアカウントはすでに連携済みです。';
			...
			case 'accountPage.diaLog.google_text': return '現在のアカウントとGoogleアカウントの連携を解除しますか？';
			case 'accountPage.diaLog.apple_text': return '現在のアカウントとAppleアカウントの連携を解除しますか？';
