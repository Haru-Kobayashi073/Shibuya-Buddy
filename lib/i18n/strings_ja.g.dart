...
class _TranslationsChangeLanguagePageJa implements TranslationsChangeLanguagePageEn {
	...
	// Translations
	@override late final _TranslationsChangeLanguagePageTitleJa title = _TranslationsChangeLanguagePageTitleJa._(_root);
...
class _TranslationsChangeLanguagePageTitleJa implements TranslationsChangeLanguagePageTitleEn {
...
extension on TranslationsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'ChangeLanguagePage.title.title': return '言語';
